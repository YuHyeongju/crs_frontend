...
import UserTypeSelectionPage from './pages/auth/UserTypeSelectionPage';                // 사용자 유형 선택 페이지
import GeneralTermsPage from './pages/auth/GeneralTermsPage';                          // 일반 사용자 약관 페이지
import MerchantTermsPage from './pages/auth/MerchantTermsPage';                        // 상인 약관 페이지
import AdminTermsPage from './pages/auth/AdminTermsPage';                              // 관리자 약관 페이지
import GeneralSignUpPage from './pages/auth/GeneralSignUpPage';                        // 일반 사용자 회원가입 페이지
import MerchantSignUpPage from './pages/auth/MerchantSignUpPage';                      // 상인 회원가입 페이지
import AdminSignUpPage from './pages/auth/AdminSignUpPage';                            // 관리자 회원가입 페이지
import MyPage from './pages/mypage/MyPage';                                            // 마이페이지
import { AuthProvider } from './context/AuthContext';                                  // 인증 상태 관리 
import MerchantSelectPanel from './pages/mypage/merchant/MerchantSelectPanel';         // 식당 선택 컴포넌트 추가
