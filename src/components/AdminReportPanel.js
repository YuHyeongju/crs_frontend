...
//     if (window.confirm(`리뷰 신고 ID ${reportId}를 처리하시겠습니까?`)) {
//       alert(`리뷰 신고 ID ${reportId}가 처리되었습니다.`);
//       // 실제로는 서버 API를 호출하여 신고를 처리하고, 리뷰를 삭제하거나 사용자를 제재하는 등의 로직을 구현합니다.
...
//     processButton: { padding: '8px 12px', borderRadius: '5px', border: 'none', cursor: 'pointer', fontSize: '12px', fontWeight: 'bold', backgroundColor: '#007bff', color: 'white' },
//   };
...
//                   <button onClick={() => handleProcess(report.id)} style={styles.processButton}>처리</button>
//                 </td>
//               </tr>
//             ))
//           ) : (
