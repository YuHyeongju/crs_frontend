...
//         case '혼잡도 이력 없음': return '#6c757d';
//         default: return '#6c757d';
//     }
// };

// // 2. 서버 DB의 ID와 매핑하는 객체 (1: 여유, 2: 보통, 3: 혼잡, 4: 매우 혼잡, 0: 데이터 없음)
...
//         console.log("현재 선택된 값(newCongestion):", `"${newCongestion}"`); 
//         console.log("매핑 결과(sendStatus):", CONGESTION_MAP[newCongestion]);
//         try {
