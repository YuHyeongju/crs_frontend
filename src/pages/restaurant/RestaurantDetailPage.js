...
//                 if (matched) {
//                     try {
//                         // 1. 서버에 식당 정보 전송 및 응답 받기
//                         // restRes.data 에는 { restIdx: 12, restName: "...", ... } 가 들어있어야 함
...
//                         setRestaurant({
//                             ...matched, 
//                             // [핵심 수정] 카카오의 id를 서버에서 준 진짜 DB PK(restIdx)로 덮어씌움!!
//                             id: restRes.data.restIdx, 
...
//                     {/* [수정 완료] 이제 restaurant.id는 진짜 서버 PK값이므로 그대로 넘겨줌 */}
//                     {activeTab === 'reviews' && (
//                         <ReviewsTab 
            ...
            <div style={styles.card}>
                ...
                <div style={{ marginTop: '20px' }}>
                    ...
                    {activeTab === 'reviews' && (
                        <ReviewsTab 
                            restaurant={restaurant} 
                            // 이미 restaurant.id가 DB PK로 바뀌었으므로 그대로 전달
                            restIdx={restaurant.id} 
                        />
                    )}
                </div>
