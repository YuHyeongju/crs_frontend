...
//     restaurantItem: { display: 'flex', alignItems: 'center', padding: '15px', backgroundColor: '#fff', border: '1px solid #ddd', borderRadius: '10px', boxShadow: '0 2px 5px rgba(0,0,0,0.05)' },
//     restaurantImage: { width: '80px', height: '80px', borderRadius: '8px', objectFit: 'cover', marginRight: '20px' },
...
//                 <img src={restaurant.imageUrl || "https://via.placeholder.com/300x200/f0f0f0/999999?text=No+Image"} alt="식당 이미지" style={styles.restaurantImage} />
...
//                       state: { restaurantName: restaurant.restName } // ★ 이름 전달
//                     })}
//                   >상세보기</button>
